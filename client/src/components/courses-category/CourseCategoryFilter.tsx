    ...
    <div>
      <div className="flex items-center gap-3 w-[400px] justify-between">
        <button
          ...
          className="md:flex hidden items-center justify-center gap-2 border h-[60px] w-[150px] dark:border-gray8 border-gray3"
        >
          <IoFilterOutline />
      ...
      <div className="flex gap-5 mt-5">
        ...
        <motion.div
          layout
          className={`${
            isOpenFilter ? "md:w-[calc(100%-400px)]" : "md:w-full"
          } `}
        >
