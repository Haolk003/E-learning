    ...
    <div className="w-full">
      <div className="flex py-2 gap-x-2 border-b px-4 items-center [&>*]:px-2 [&>*]:h-10 [&>*:hover]:hover:bg-gray-100 [&>*]:rounded-lg overflow-x-auto">
        ...
        <button
          ...
          className={editor.isActive("bold") ? "bg-gray-100 dark:bg-black" : ""}
        >
        ...
        <button
          ...
          className={
            editor.isActive("italic") ? "bg-gray-100 dark:bg-black" : ""
          }
        >
        ...
        <button
          ...
          className={
            editor.isActive("strike") ? "bg-gray-100 dark:bg-black" : ""
          }
        >
        ...
        <button
          ...
          className={
            editor.isActive("bulletList") ? "bg-gray-100 dark:bg-black" : ""
          }
        >
        ...
        <button
          ...
          className={
            editor.isActive("orderedList") ? "bg-gray-100 dark:bg-black" : ""
          }
        >
        ...
        <button
          ...
          className={
            editor.isActive("blockquote") ? "bg-gray-100 dark:bg-black" : ""
          }
        >
        ...
        <button
          ...
          className={
            editor.isActive("paragraph") ? "bg-gray-100 dark:bg-black" : ""
          }
        >
